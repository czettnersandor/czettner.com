...
OLD_DOMAIN = "https://czettner.com"  ## TODO replace this out
NEW_DOMAIN = "https://czettner.com"         ## TODO replace this out
...
SQL
    ...
    # Main script
    #
    def self.process(dbname, user, pass, host = DRUPAL_HOST)
...
Jekyll::Drupal.process(DRUPAL_DATABASE, DRUPAL_USER, DRUPAL_PASSWORD)
